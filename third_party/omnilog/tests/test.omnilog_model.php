...
class Test_omnilog_model extends Testee_unit_test_case {
  ...
  public function test__constructor__package_name_and_version()
  {
    ...
    $this->assertIdentical($package_version,
      $subject->get_package_version());
  }
  ...
  public function test__get_installed_version__success()
  {
    ...
    $db->expectOnce('get_where',
      array('modules', array('module_name' => $this->_package_name), 1));
  ...
  public function test__get_log_entries__success_default_site_id()
  {
    ...
    $this->assertIdentical($length, count($actual_result));
  ...
  public function test__notify_site_admin_of_log_entry__success()
  {
    ...
    $lang->setReturnValue('line', $lang_log_message,
      array('email_log_message'));

    $lang->setReturnValue('line', $lang_log_extended,
      array('email_log_extended_data'));
  ...
  public function test__notify_site_admin_of_log_entry__missing_log_data()
  {
    ...
    $error_message = 'Error';
    $lang->setReturnValue('line', $error_message,
      array('exception__notify_admin__missing_data'));
  ...
  public function test__notify_site_admin_of_log_entry__invalid_webmaster_email()
  {
    ...
    $error_message = 'Error';
    $lang->setReturnValue('line', $error_message,
      array('exception__notify_admin__invalid_webmaster_email'));
  ...
  public function test__notify_site_admin_of_log_entry__email_not_sent()
  {
    ...
    $error_message = 'Error';
    $lang->setReturnValue('line', $error_message,
      array('exception__notify_admin__email_not_sent'));
  ...
  public function test__update_package__update_to_version_110()
  {
    ...
    $column = array('admin_emails' => array('type' => 'MEDIUMTEXT'));

    $this->EE->dbforge->expectAtLeastOnce('add_column');

    $this->EE->dbforge->expectAt(0, 'add_column',
  ...
  public function test__update_package__update_to_version_122()
  {
    ...
    $column = array('extended_data' => array('type' => 'TEXT'));
